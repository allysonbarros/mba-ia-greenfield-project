...
import { CreateVideos1783526745739 } from './migrations/1783526745739-CreateVideos';
...
describe('Database migrations (integration)', () => {
  ...
  beforeAll(async () => {
    ...
    await dataSource.query(`DROP TYPE IF EXISTS "video_status"`);
  });
